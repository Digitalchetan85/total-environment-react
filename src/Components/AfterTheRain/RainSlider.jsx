            ...
            <Row className="">
              <Col md={8} className="">
                <div className="m-1 text-center text-md-start">
                  <h1 className="fs-4">Total Environment After the Rain</h1>
                  {/* <p className="m-0"> */}
                    <p className="text-center text-md-start mb-0">Yelhanka, North Bangalore</p>
                    <p className="text-center text-md-start mb-0">starts @ ₹ 5.17Cr* Onwards</p>
                  {/* </p> */}
                </div>
              </Col>
