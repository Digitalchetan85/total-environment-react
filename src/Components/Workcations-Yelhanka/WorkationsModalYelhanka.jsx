...
const WorkationsModalYelhanka = (props) => {
  ...
  const onSubmit = (values) => {
    const data = {
      ...
      lastname: "",
      source: "Total Environment Workcations - Pursuit Of A Radical Rhapsody Commercial",
      mobile: values.phone,
...
export default WorkationsModalYelhanka;
