...
import MagicTreeModal from "./WorkationsModal";
import PursuitModal from "./WorkationsModal";

const WorkationsPrice = () => {
          ...
          <Col md={10} xs={12}>
            <div className="">
              ...
              >
                ...
                <tbody>
                  <tr>
                    <td>Workcations Office Space</td>
                    <td>500 Sq.Ft.</td>
                    <td>
                      <Button
                        variant="dark"
...
export default WorkationsPrice;
