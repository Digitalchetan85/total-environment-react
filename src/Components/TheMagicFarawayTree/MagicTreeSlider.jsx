            ...
            <Row className="">
              <Col md={8} className="">
                <div className="m-1 text-center text-md-start">
                  <h1 className="fs-2">Total Environment The Magic Faraway Tree</h1>
                  <p className="m-0">
                    <p className="text-center text-md-start mb-0">Kanakapura, Bangalore</p>
                  </p>
                </div>
              </Col>
...
export default MagicTreeSlider
